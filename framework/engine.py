...
from utils.net_size import get_net_size
...
class GenericEngine(object):
    ...
    def train(self):
        ...
        if self.args.test_with_eval:
            ...
            test_acc = self.test(best_epoch, best_acc, loader=self.source_val)
        else:
            test_acc = self.test(best_epoch, best_acc, loader=self.target_test)
