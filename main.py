...
def get_default_parser():
    ...
    parser.add_argument('--save-path', default='test'.format(dataset))
    ...
    # dataset
    parser.add_argument('--loader', default='standard', choices=['standard', 'meta', 'original'])
    ...
    parser.add_argument('--meta-lr-weight', default=50, type=float)
    parser.add_argument('--trajectory', default=3, type=int)
    parser.add_argument('--length', default=3, type=int)

    parser.add_argument('--MVP', action='store_true')
    parser.add_argument('--MVP-bs', default=8, type=int)
    parser.add_argument('--MVP-model-path', default='', help='The models path for the models')
